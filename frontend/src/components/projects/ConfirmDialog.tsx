 ...
 * Used anywhere a destructive action (delete project, delete entry, remove
 * member, etc.) should not fire immediately on click.
 */
          ...
          >
            ...
            <div className="flex justify-end gap-3 border-t border-slate-100 pt-4">
              <button
                ...
                onClick={onCancel}
                disabled={isPending}
                className="rounded-2xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {cancelLabel}
              </button>
              <button
