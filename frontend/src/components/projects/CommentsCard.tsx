      ...
      {entry.commentsEnabled ? (
        <form onSubmit={handleSubmit} className="space-y-2 border-t border-slate-100 pt-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-1.5 rounded-2xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:bg-slate-300 md:w-auto md:ml-auto"
          >
            <Send size={14} />
            Post comment
          </button>
